...
class Usuario extends \Models\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getUsId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getUsId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUsId', array());

        return parent::getUsId();
    }
    ...
    public function setVerificado($verificado)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVerificado', array($verificado));

        return parent::setVerificado($verificado);
    }
