...
namespace ModelsProxy\__CG__\Models;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Mensagem extends \Models\Mensagem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Models\\Mensagem' . "\0" . 'msgId', '' . "\0" . 'Models\\Mensagem' . "\0" . 'dataTs', '' . "\0" . 'Models\\Mensagem' . "\0" . 'conteudo', '' . "\0" . 'Models\\Mensagem' . "\0" . 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Mensagem $proxy) {
    ...
    public function setDataTs($dataTs)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDataTs', array($dataTs));

        return parent::setDataTs($dataTs);
    }
    ...
    public function getDataTs()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDataTs', array());

        return parent::getDataTs();
    }
